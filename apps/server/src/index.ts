      ...
      const leadsData = [
        {
          ...
          companyId: tenantCompany.id,
          clientId:
            seededClients.find((c) => c.name === "TechCorp Solutions")?.id ??
            null,
        ...
        },
        {
          ...
          companyId: tenantCompany.id,
          clientId:
            seededClients.find((c) => c.name === "Apex Retail Group")?.id ??
            null,
        ...
        },
        {
          ...
          companyId: tenantCompany.id,
          clientId:
            seededClients.find((c) => c.name === "Nova BioTech")?.id ?? null,
        ...
        },
        {
          ...
          companyId: tenantCompany.id,
          clientId:
            seededClients.find((c) => c.name === "Summit Financials")?.id ??
            null,
        ...
        },
        {
          ...
          companyId: tenantCompany.id,
          clientId:
            seededClients.find((c) => c.name === "GreenEnergy Co.")?.id ?? null,
          notes:
            "High interest in setting up commercial solar array next quarter.",
          source: "linkedin",
        ...
        },
        {
          ...
          companyId: tenantCompany.id,
          notes:
            "Individual consultant, looking for single user license option.",
          source: "website",
        },
      ];
